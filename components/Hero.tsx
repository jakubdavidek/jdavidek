...
export default function Hero() {
  ...
  return (
    <section style={{
      ...
      <div style={{
        position: "absolute", inset: 0,
        background: "linear-gradient(to right, rgba(13,13,13,0.95) 0%, rgba(13,13,13,0.4) 20%)",
        pointerEvents: "none",
      }} />
      ...
      <div style={{ position: "relative", zIndex: 1, maxWidth: 1280, margin: "0 auto", width: "100%" }}>
        ...
        <motion.div {...fadeUp(0.1)} style={{
          ...
          <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#ea6c00" }}>Plzeň &amp; okolí</span>
          <span style={{ width: 28, height: 1, background: "rgba(234,108,0,0.5)", display: "block", flexShrink: 0 }} />
          <span style={{ fontSize: 10, fontWeight: 700, letterSpacing: "0.18em", textTransform: "uppercase", color: "#ea6c00" }}>Od roku 2005</span>
        </motion.div>
        ...
        <motion.h1 {...fadeUp(0.2)} style={{
          ...
          color: "#fff", margin: "0 0 1.5rem", fontWeight: 400,
        }}>
          My<br />
        ...
        <motion.p {...fadeUp(0.35)} style={{
          ...
          maxWidth: 380, lineHeight: 1.75, marginBottom: "2.25rem",
        }}>
        ...
        <motion.div {...fadeUp(0.45)} style={{ display: "flex", flexWrap: "wrap", gap: 10, marginBottom: "3rem" }}>
          <button onClick={() => scrollTo("#kontakt")} style={{
            ...
            fontSize: 14, fontWeight: 600, fontFamily: "inherit", transition: "background 0.2s, transform 0.2s",
          }}
          ...
          ><Sparkles size={15} /> Nezávazná poptávka</button>

          <button onClick={() => scrollTo("#sluzby")} style={{
            display: "flex", alignItems: "center", gap: 6,
            background: "transparent", color: "rgba(255,255,255,0.8)",
            border: "1px solid rgba(255,255,255,0.2)", cursor: "pointer",
            padding: "12px 22px", borderRadius: 9999,
            fontSize: 14, fontWeight: 500, fontFamily: "inherit", transition: "all 0.2s",
          }}
            onMouseEnter={e => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.5)"; e.currentTarget.style.color = "#fff"; }}
            onMouseLeave={e => { e.currentTarget.style.borderColor = "rgba(255,255,255,0.2)"; e.currentTarget.style.color = "rgba(255,255,255,0.8)"; }}
          >Prohlédnout služby</button>
        </motion.div>
        ...
        >
          {[
            ...
            <div key={stat.label} style={{ borderLeft: "2px solid #ea6c00", paddingLeft: 14 }}>
              <div style={{ fontFamily: "var(--font-display,'DM Serif Display',Georgia,serif)", fontSize: "1.6rem", color: "#fff", lineHeight: 1, fontWeight: 400 }}>{stat.value}</div>
              <div style={{ fontSize: 9, letterSpacing: "0.15em", textTransform: "uppercase", color: "rgba(255,255,255,0.38)", marginTop: 4 }}>{stat.label}</div>
            </div>
          ))}
        </motion.div>
      </div>
